...
generatedAt: 2026-05-28T15:46:43.831Z
model: gpt-4o-mini
...
## Purpose
This OpenAPI tag covers the management of domain groups, including operations related to creating, updating, retrieving, and deleting domain groups for API-key clients.
...
- **`GET /api/v1/organization/usage`** (not part of Domain Groups) - for checking current rate limits.
