...
generatedAt: 2026-06-14T15:27:08.945Z
model: gpt-4o-mini
...
- **Error Codes**:
  ...
  - `400`: Request body or query validation failed; check `details` and `requestId` in the JSON response.
...
- **RedirectTest**: CI fixture storing input and expected output for validation.
