...
This page is a **guide index** — pick a linked guide for your task; use the reading order below for conditionals.
...
In the sidebar, open **Redirect Rules** and select **Add rule** to walk through the wizard (scope, matching, destination, status). See [Redirect rules in the dashboard](./dashboard/redirect-rules-in-dashboard.md).
...
| [Redirect rules in the dashboard](./dashboard/redirect-rules-in-dashboard.md) | UI wizard, table filter, redirect tests card |
